...
io.println("qsort time is ", t1*1000, " ms");           // 23
io.println("factorial time is ", t2*1000, " ms");       // 0.5
io.println("fib time is ", t3*1000, " ms");             // 0.3
io.println("fib2 time is ", t4*1000, " ms");            // 1250
